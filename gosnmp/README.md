...
[![Coverage](http://gocover.io/_badge/sys_monitor/gosnmp)](http://gocover.io/sys_monitor/gosnmp)
[![GoDoc](https://godoc.org/sys_monitor/gosnmp?status.png)](http://godoc.org/sys_monitor/gosnmp)
https://sys_monitor/gosnmp
...
* Chris Dance ([@codedance](https://sys_monitor/codedance/))
* Nathan Owens ([@virtuallynathan](https://sys_monitor/virtuallynathan/))
* Whitham Reeve ([@wdreeveii](https://sys_monitor/wdreeveii/))
...
Install via **go get**:
    ...
    go get sys_monitor/gosnmp

Documentation
-------------

See http://godoc.org/sys_monitor/gosnmp or your local go doc
...
Please create an [issue](https://sys_monitor/gosnmp/issues) on
...
To check test coverage:
    ...
    go get sys_monitor/axw/gocov/gocov
    go get sys_monitor/matm/gocov-html
    gocov test sys_monitor/gosnmp | gocov-html > gosnmp.html && firefox gosnmp.html &
